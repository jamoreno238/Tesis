...
import { registrarEvaluadorExterno } from "../../../services/secretariaServicios";

const RegistrarEvaluadorExterno = ({ isOpen, onClose }) => {
  ...
  const handleEnviarClick = () => {
    ...
    registrarEvaluadorExterno(datosPersonales)
      .then((response) => {
        alert("Registro realizado con éxito", response);
        window.location.reload();
      })
      .catch((error) => {
        alert("Error al Registrar Evaluador Externo", error);
        console.error("Error al Registrar Evaluador Externo:", error);
      });
  ...
  return (
    <Dialog open={isOpen} onClose={onClose} maxWidth="md" fullWidth>
      <DialogTitle textAlign={"center"}>
        Ingrese los Datos del Evaludaor Externo
      </DialogTitle>
      <DialogContent>
        <Box>
...
export default RegistrarEvaluadorExterno;

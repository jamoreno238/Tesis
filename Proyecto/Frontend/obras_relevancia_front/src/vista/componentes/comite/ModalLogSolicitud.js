...
import Plantilla from "../menu/PlantillaComite.js";
import "../../../css/asignarPerfiles.css";
import { obtenerLogSolicitudes } from "../../../services/comiteServicios.js";
            ...
            {data
              ...
              .map((row) => (
                <TableRow key={row.PER_ID}>
                  ...
                  <TableCell>{row.LOG_FECHA_ACTUALIZACION}</TableCell>

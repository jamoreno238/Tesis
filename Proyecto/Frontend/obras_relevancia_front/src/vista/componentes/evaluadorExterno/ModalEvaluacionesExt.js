...
import { getEvaluacionesEvaluadorExternoModal } from "../../../services/evaluadorExternoServicios";
...
const ModalEvaluacionesExt = ({ open, handleClose, selectedRow }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      if (selectedRow && selectedRow.DOC_ID) {
        ...
        try {
          const result = await getEvaluacionesEvaluadorExternoModal(
            selectedRow.DOC_ID
          );
...
export default ModalEvaluacionesExt;

    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: "flex" }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav">
            <ListItem button component={Link} to="/inicioEvaExt">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem button component={Link} to="/cambioContraEvaExt">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem button component={Link} to="/misEvaluacionesEvaExt">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,

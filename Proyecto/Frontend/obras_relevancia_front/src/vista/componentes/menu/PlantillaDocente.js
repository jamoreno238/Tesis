    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: "flex" }}>
        ...
        <Drawer variant="permanent" open={open}>
          ...
          <List component="nav">
            <ListItem button component={Link} to="/inicioDocente">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem button component={Link} to="/cambioContraDocente">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,
            ...
            <ListItem button component={Link} to="/solicitudesDocente">
              <ListItemButton>
                <ListItemIcon
                  sx={{
                    minWidth: 0,
                ...
                <ListItemText className="item-text" primary="Mis Solicitudes" />
              </ListItemButton>
            </ListItem>

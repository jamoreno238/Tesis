...
import Plantilla from "../../componentes/menu/PlantillaEvaExt";
import ModalEvaluacionesExt from "../../componentes/evaluadorExterno/ModalEvaluacionesExt";
import { useNavigate } from "react-router-dom";
import { getEvaluacionesEvaluadorExterno } from "../../../services/evaluadorExternoServicios";
import "../../../css/asignarPerfiles.css";
import Cookies from "js-cookie";
import { decodeToken } from "react-jwt";

const MisSolicitudesEvaExt = () => {
      ...
      const fetchData = async () => {
        try {
          ...
          if (token) {
            ...
            const result = await getEvaluacionesEvaluadorExterno(
              decodedToken.idUsuario
            );
  ...
  const handleDocumentoClick = (row) => {
    if (row.EVA_ESTADO_NOMBRE !== "Asignado") {
      ...
      navigate(`/evaluarSolicitudExt?codigo=${codigo}&tipo_req=${tipo_req}`);
    }
  };
...
export default MisSolicitudesEvaExt;

...
const title = "Bienvenid@ Miembro de Comité " + nombre + " " + apellido;
...
const InicioComite = () => {
  ...
  return (
    <Plantilla title={title}>
      <img src={logoEspe} className="imgInicio" alt="Imagen Comite" />
    </Plantilla>
  );
};

export default InicioComite;

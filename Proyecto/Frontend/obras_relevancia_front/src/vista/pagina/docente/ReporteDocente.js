...
import { getEvaluacionesDocente } from "../../../services/docenteServicios.js";
import { getLinkEvaluaciones } from "../../../services/docenteServicios.js";
...
const EvaluacionSecretaria = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const result = await getEvaluacionesDocente(codigo);
  ...
  const handleDocumentoClick = (row) => {
    ...
    navigate(`/evaluacionDocente?codigo=${codigo}`);
  };

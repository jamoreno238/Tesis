...
import ModalUsuario from "../../componentes/secretaria/ModalUsuario.js";
import { obtenerUsuarios } from "../../../services/secretariaServicios";
import "../../../css/asignarPerfiles.css";
import Cookies from "js-cookie";
import { decodeToken } from "react-jwt";

const estadoSolicitud = ["Diplomado Academico", "Master", "Ingeniero"];
...
const Usuario = () => {
  ...
  const handleEstadoSolicitudChange = (event) => {
